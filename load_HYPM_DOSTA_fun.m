function [wfp] = load_HYPM_DOSTA_fun(filename_DOSTA)
...
%Load DOSTA data
   ...
   wfp.oxygen_L2 = ncread(filename_DOSTA,'dissolved_oxygen');%data_product_identifier = 'DOXYGEN_L2'
...
% %% Calculate density in raw profiles - note that salinity hasn't been corrected yet
...
% scivars = [wfp.temperature_dosta, wfp.pracsal_dosta, wfp.oxygen_L1, wfp.oxygen_L2, wfp.optode_temperature];
